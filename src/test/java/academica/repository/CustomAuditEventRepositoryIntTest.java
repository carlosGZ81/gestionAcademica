package academica.repository;

import academica.GestionAcademicaApp;
import academica.config.Constants;
import academica.config.audit.AuditEventConverter;
import academica.domain.PersistentAuditEvent;
...
import static academica.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
