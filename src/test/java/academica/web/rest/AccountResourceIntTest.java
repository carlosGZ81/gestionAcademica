package academica.web.rest;

import academica.config.Constants;
import academica.GestionAcademicaApp;
import academica.domain.Authority;
import academica.domain.User;
import academica.repository.AuthorityRepository;
import academica.repository.UserRepository;
import academica.security.AuthoritiesConstants;
import academica.service.MailService;
import academica.service.dto.UserDTO;
import academica.web.rest.errors.ExceptionTranslator;
import academica.web.rest.vm.KeyAndPasswordVM;
import academica.web.rest.vm.ManagedUserVM;
import academica.service.UserService;
...
@SpringBootTest(classes = GestionAcademicaApp.class)
